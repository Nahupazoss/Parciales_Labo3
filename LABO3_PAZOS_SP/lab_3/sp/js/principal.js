...
function VerificarJWT() {
    ...
    $.ajax({
        ...
        if (obj_rta.exito) {
            ...
            let alerta = ArmarAlert("Usuario: " + JSON.stringify(usuario) + "<br>Alumno: " + JSON.stringify(alumno) + "<br>DNI: " + dni);
            $("#divResultado").html(alerta).toggle(2000);
            $("#nombre_usuario").html(JSON.stringify(obj_rta.payload.nombre));
        }
        else {
