...
(function (PrimerParcial) {
    class Manejadora {
        ...
        // Informar por consola el mensaje recibido y mostrar el listado en la página (div id='divTabla').
        static MostrarAutoBD(tipoTabla) {
        ...
        ModificarAuto() { }
        static ModificarAutoBDSinFoto() {
            const inpId = document.getElementById("idAuto");
            ...
            let patente = inpPatente.value;
            let color = inpColor.value;
            let precio = parseFloat(inpPrecio.value);
            const Auto = {
                id: id,
                marca: marca,
                patente: patente,
        ...
        static ModificarObjetoEnServidor(objetoActualizado) {
            const xhttp = new XMLHttpRequest();
        ...
        static BtnModificarAuto(obj) {
            // Rellenar el formulario con los valores del objeto
            document.getElementById("idAuto").value = obj.id;
            document.getElementById("marca").value = obj.marca;
            document.getElementById("patente").value = obj.patente;
        ...
        static VerificarAutoBD() {
            ...
            xhttp.onreadystatechange = () => {
                if (xhttp.readyState == 4 && xhttp.status == 200) {
                    let respuesta = JSON.parse(xhttp.responseText);
                    const contenedorInfo = document.getElementById("divInfo");
        ...
        // Retornar un JSON que contendrá: éxito(bool) y mensaje(string) indicando lo acontecido.
        // Informar por consola y alert lo acontecido. Refrescar el listado para visualizar los cambios.
        BorrarAutoBDFoto(obj) { }
        static BorrarAutoBDFoto(obj) {
        ...
        static BtnModificarAutoBDFoto(obj) {
            document.getElementById("idAuto").value = obj.id;
            document.getElementById("marca").value = obj.marca;
            document.getElementById("patente").value = obj.patente;
            document.getElementById("color").value = obj.color;
